...
const DemoComputer = (props: Props) => {
  ...
  const txt = useVideoTexture(props.videotexture ? props.videotexture : '/textures/project/project1.mp4', {
    start: true, // Start playback automatically
    muted: true, // Mute the video if needed
    loop: true,  // Loop the video if needed
  });

  const imgText = useTexture(props.imagetexture ? props.imagetexture : '/textures/project/project1.png');
    ...
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        <mesh
           ...
           <meshLambertMaterial map={txt} toneMapped={false} />
        </mesh>
