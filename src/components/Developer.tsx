...
import { Mesh, Object3D, Skeleton } from 'three';

type SkinnedMesh = Object3D & {
    skeleton: Skeleton;
  };
...
const Developer = ({ animationName = 'idle', ...props }) => {
  ...
  useEffect(() => {
    actions[animationName] && actions[animationName].reset().fadeIn(0.5).play();
    return () => {
      actions[animationName] && actions[animationName].fadeOut(0.5);
      return undefined;
    };
  }, [animationName]);
